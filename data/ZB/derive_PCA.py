...
leaveout_type = ["two_forecasting", "three_interpolation", "remove_recovery", "all_times"][3]
test_tpsS_dict = {"two_forecasting":[10,11], "three_interpolation":[4,6,8], "remove_recovery":[2,4,6,8,10,11], "all_times":[]}
...
cell_set_meta = pd.read_csv("cell_groups_meta.csv", header=0, index_col=0)
